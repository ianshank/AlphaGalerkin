...
### Gate 7 — Coverage
```bash
COVERAGE_CORE=pytrace pytest tests/pde/certificate/ -v --cov=src/pde/certificate --cov-branch --cov-fail-under=85
```
...
- Conventions: `.agents/skills/new-pde-operator/SKILL.md` (manufactured-solution
