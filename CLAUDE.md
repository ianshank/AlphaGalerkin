...
- [2026-08-16]: **Sprint Hardening & Test Pyramid Expansion (v0.4.0-dev)** — 7-tier test pyramid expansion (705+ tests, 0 failures), Core Protocols (`src/core/protocols.py`, `src/core/registry.py`), domain-specific constants (`src/mcts/constants.py`, `src/physics/constants.py`, `src/training/constants.py`), Agent Lifecycle Hooks (`src/agents/lifecycle_hooks.py`), Reusable Agent Skills (`src/agents/skills/`), SBIR demo flags (`--demo`, `--export-results`), and comprehensive reference documentation.
