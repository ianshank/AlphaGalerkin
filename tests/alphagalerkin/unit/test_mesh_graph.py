...
class TestMeshGraphRefinement:
    ...
    def test_h_refine_quad(
        ...
        assert quad_mesh_2x2.num_elements == initial_count + 3
    ...
    def test_h_refine_triangle(
        ...
        assert len(new_ids) == 4
        assert tri_mesh_small.num_elements == initial_count + 3
...
class TestMeshGraphProperties:
    ...
    def test_clone_is_independent(
        ...
        assert cloned.num_elements == quad_mesh_2x2.num_elements
    ...
    def test_get_nonexistent_element_raises(
        ...
        with pytest.raises(KeyError):
            quad_mesh_2x2.get_element(ElementID("nonexistent"))
