...
class TestDatasetSplits:
    ...
    def test_splits_reproducible(self) -> None:
        ...
        train1, val1, test1 = PhysicsDataset.create_splits(solver, n_train=20, n_val=5, n_test=5, seed=42)
        train2, val2, test2 = PhysicsDataset.create_splits(solver, n_train=20, n_val=5, n_test=5, seed=42)
