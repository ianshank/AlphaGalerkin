...
class TestMCTSRateController:
    ...
    def test_mcts_qp_selection(self, codec_with_mcts) -> None:
        ...
        if hasattr(codec_with_mcts, 'rate_controller') and codec_with_mcts.rate_controller is not None:
...
class TestGOPRateAllocation:
    ...
    def test_gop_manager_frame_types(self, mcts_config) -> None:
        ...
        from src.video_compression.codec.gop_manager import GOPManager, FrameType
...
class TestBitrateTargeting:
    ...
    def test_encode_respects_qp(self, synthetic_video_factory, dummy_codec_checkpoint, tmp_path) -> None:
        ...
        for qp in [22, 32, 42]:
            ...
            result = subprocess.run(
                [
                    sys.executable, "scripts/encode_video.py",
