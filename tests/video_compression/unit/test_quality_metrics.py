...
class TestPSNR:
    ...
    def test_psnr_identical_images(self, identical_frames: tuple[torch.Tensor, torch.Tensor]) -> None:
    ...
    def test_psnr_different_images(self, different_frames: tuple[torch.Tensor, torch.Tensor]) -> None:
...
class TestSSIM:
    ...
    def test_ssim_identical_images(self, identical_frames: tuple[torch.Tensor, torch.Tensor]) -> None:
    ...
    def test_ssim_different_images(self, different_frames: tuple[torch.Tensor, torch.Tensor]) -> None:
